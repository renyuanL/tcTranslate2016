...
from turtle import *
from turtle import _CFG, _Screen, _Root, TK, _TurtleImage, Tbuffer, TurtleGraphicsError, TurtleScreenBase, TurtleScreen, TNavigator, TPen, RawTurtle, Canvas #, Turtle, Screen
...
def 印出物類內別名表():
    ...
    for y in classBeChanged:
        #
        # turtle_tc_alias.py 中所有的 別名變數列表 
        #
        '''
